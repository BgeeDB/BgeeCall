...
```{r, echo=FALSE}
user_BgeeCall@working_path <- system.file("extdata", package = "BgeeCall")
...
unlink(file.path(user_BgeeCall@working_path, paste0(getIntergenicPrefix(bgee), "*")), recursive = TRUE)
```
