...
#' @slot fasta_intergenic_url URL to fasta file containing reference 
#' intergenic regions as defined by the Bgee pipeline 
#' (https://github.com/BgeeDB/bgee_pipeline/tree/master/pipeline/RNA_Seq)
#' @slot fasta_intergenic_name Name of the fasta file containing all 
...
setMethod(f = "initialize", signature ="BgeeMetadata" , 
          definition = function(.Object, ...) {
              ...
              allReleases <- try(.getIntergenicRelease(removeFile = FALSE), 
                                 silent=TRUE)
...
may not be up to date!\n"))
                      ...
                      stop("ERROR: BgeeCall could not access Bgee 
