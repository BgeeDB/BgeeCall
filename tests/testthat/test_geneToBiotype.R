...
test_that("test generation of gene to biotype file", {
  ...
  expect_failure(expect_error(test <- load_gene_to_biotype(kallisto, bgee, user), NULL))
  expect_equal(nrow(test), 51025)
